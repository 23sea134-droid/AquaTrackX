...
const CustomTabBar = ({ state, descriptors, navigation }) => {
  ...
  const getIconName = (routeName) => {
    switch (routeName) {
      ...
      // REMOVED: "Alerts" case since it's no longer in tab bar
      default:
        return "home";
    }
  };
  ...
  const tabWidth = (width - 40) / state.routes.length; // 40 = left(20) + right(20) padding
...
// ====================
// Tab Navigator with Auth Listener Cleanup
// ====================
const TabNavigator = () => {
  const { user } = useAuth();
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      >
        ...
        {/* REMOVED: Alerts tab from navigation bar */}
...
// ====================
// Enhanced Loading Screen - Matching HomeScreen Theme
// ====================
  ...
  return (
    <LinearGradient colors={['#030712', '#111827', '#000000']} style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
      ...
      <View style={{
        ...
        {/* Water droplet icon with pulse animation */}
        <Animated.View style={{
        ...
        {/* Custom rotating loading indicator */}
        <Animated.View style={{
          transform: [{ rotate }],
          marginBottom: 20,
        }}>
  ...
  return user ? (
    <TabBarProvider>
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        ...
        {/* Add Alerts as a stack screen (accessible from HomeScreen bell icon) */}
        <Stack.Screen 
          name="Alerts" 
